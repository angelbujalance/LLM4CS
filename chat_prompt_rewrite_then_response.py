...
def get_args():
    ...
    parser.add_argument("--rewrite_file_path", type=str, required=True)
    ...
    with open(output_file_path, "a+") as fw:
        for i in trange(len(test_dialogs)):
            ...
            for i in trange(len(turns)):
                ...
                current_turn['question'] = d_rewrite[sample_id] # modify the current question to rewrite
                ...
                record['predicted_rewrite'] = [current_turn['question']]
