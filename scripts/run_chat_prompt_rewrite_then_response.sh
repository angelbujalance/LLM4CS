...
#SBATCH --output=output/success/out-RTR_prompting.out
#SBATCH --error=output/error/out-RTR_prompting.err
...
--rewrite_file_path="./results/new/cast19/RTR/rewrites.jsonl" \
--n_generation=5 \